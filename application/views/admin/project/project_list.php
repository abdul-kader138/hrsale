...
<div class="row <?php echo $get_animate;?>">
  <div class="col-md-3 col-sm-6 col-xs-12">
    <div class="info-box"> <span class="info-box-icon bg-aqua"><i class="fa fa-tasks"></i></span>
      <div class="info-box-content"> <span class="info-box-text"><?php echo $this->lang->line('xin_not_started');?></span> <span class="info-box-number"><?php echo $this->Project_model->not_started_projects(); ?></span> </div>
      <!-- /.info-box-content --> 
    </div>
    <!-- /.info-box --> 
  </div>
  ...
  <div class="col-md-3 col-sm-6 col-xs-12">
    <div class="info-box"> <span class="info-box-icon bg-red"><i class="fa fa-tasks"></i></span>
      <div class="info-box-content"> <span class="info-box-text"><?php echo $this->lang->line('xin_in_progress');?></span> <span class="info-box-number"><?php echo $this->Project_model->inprogress_projects();?></span> </div>
      <!-- /.info-box-content --> 
    </div>
    <!-- /.info-box --> 
  </div>
  ...
  <div class="col-md-3 col-sm-6 col-xs-12">
    <div class="info-box"> <span class="info-box-icon bg-green"><i class="fa fa-tasks"></i></span>
      <div class="info-box-content"> <span class="info-box-text"><?php echo $this->lang->line('xin_completed');?></span> <span class="info-box-number"><?php echo $this->Project_model->complete_projects(); ?></span> </div>
      <!-- /.info-box-content --> 
    </div>
    <!-- /.info-box --> 
  </div>
  ...
  <div class="col-md-3 col-sm-6 col-xs-12">
    <div class="info-box"> <span class="info-box-icon bg-yellow"><i class="fa fa-tasks"></i></span>
      <div class="info-box-content"> <span class="info-box-text"><?php echo $this->lang->line('xin_deffered');?></span> <span class="info-box-number"><?php echo $this->Project_model->deffered_projects(); ?></span> </div>
      <!-- /.info-box-content --> 
    </div>
    <!-- /.info-box --> 
  </div>
