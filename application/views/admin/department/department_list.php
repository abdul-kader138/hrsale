    ...
    <div class="box">
      ...
      <?php echo form_open('admin/department/add_department', $attributes, $hidden);?>
        ...
        <div class="form-group">
          ...
          <select class=" form-control select2 select2-hidden-accessible" name="company_id" id="aj_company" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('left_company');?>">
            <option value=""></option>
