        ...
        <div class="col-md-3">
          <div class="box-body">
            ...
            <?php if($system[0]->module_events=='true'){?>
              ...
              <span class="list-group-item calendar-options" style="background:#ffaddf;"> <?php echo $this->lang->line('xin_hr_events');?></span>
              <?php } ?>
              <?php if(in_array('99',$role_resources_ids)) { ?>
              <span class="list-group-item calendar-options" style="background:#ccf9ff;"> <?php echo $this->lang->line('xin_hr_meetings');?></span>
              <?php } ?>
            <?php } ?>
            </div>
          </div>
