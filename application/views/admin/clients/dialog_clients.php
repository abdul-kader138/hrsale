      ...
      <div class="col-md-3">
        <fieldset class="form-group">
          ...
          <?php if($client_profile!='' || $client_profile!='no-file'){?>
           <span class="avatar box-48 mr-0-5"> <img class="user-image-hr100 ui-w-100 rounded-circle" src="<?php echo base_url();?>uploads/clients/<?php echo $client_profile;?>" alt=""> </span>
          <?php } ?>    
      </div>
    </div>
  </div>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style="display: table-cell;"><?php if($client_profile!='' || $client_profile!='no-file'){?>
            <div class="avatar box-48 mr-0-5"> <img src="<?php echo base_url();?>uploads/clients/<?php echo $client_profile;?>" alt="" class="user-image-hr100 ui-w-100 rounded-circle"></a> </div>
            <?php } ?></td>
        </tr>
      </tbody>
    </table></div>
