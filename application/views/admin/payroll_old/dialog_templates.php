              ...
              <div class="card mb-2">
                ...
                <div id="set_loan_deductions" class="collapse" data-parent="#accordion" style="">
                  <div class="card-body">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                      <div class="text-muted"><strong><?php echo $r_loan->loan_deduction_title;?>:</strong></div>
                      <div><?php echo $r_loan->loan_deduction_amount;?></div></li>
                    <?php } ?>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                      <div class="text-muted"><strong>&nbsp;</strong></div>
              ...
              <div class="card mb-2">
                ...
                <div id="statutory_deductions" class="collapse" data-parent="#accordion" style="">
                  <div class="card-body">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                      <div class="text-muted"><strong><?php echo $this->lang->line('xin_employee_set_ssempee');?> (<?php echo $salary_ssempee;?>%):</strong></div>
                      ...
                      <?php } ?>
                      <?php if($salary_ssempeer!='' || $salary_ssempee!=0){?>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                      <div class="text-muted"><strong><?php echo $this->lang->line('xin_employee_set_ssempeer');?> (<?php echo $salary_ssempeer;?>%):</strong></div>
                      <?php $sta_salary1 = $allowance_amount + $basic_salary;?>
                      <?php $ssalary_ssempeer = $sta_salary1 / 100 * $salary_ssempeer;?>
                      <div><?php echo $ssalary_ssempeer = number_format((float)$ssalary_ssempeer, 2, '.', '');?></div></li>
                      <?php } else {?>
                      	<?php $ssalary_ssempeer = 0;?>
                      <?php } ?>
                      <?php if($salary_income_tax!='' || $salary_income_tax!=0){?>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                      <div class="text-muted"><strong><?php echo $this->lang->line('xin_employee_set_inc_tax');?> (<?php echo $salary_income_tax;?>%):</strong></div>
                      <?php $sta_salary2 = $allowance_amount + $basic_salary;?>
                      <?php $ssalary_income_tax = $sta_salary2 / 100 * $salary_income_tax;?>
                      <div><?php echo $ssalary_income_tax = number_format((float)$ssalary_income_tax, 2, '.', '');?></div></li>
                      <?php } else {?>
