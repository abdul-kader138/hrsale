...
$statutory_deductions = $s_ssempee + $s_ssempeer + $s_income_tax;
...
<?php echo form_open('admin/payroll/add_pay_monthly/', $attributes, $hidden);?>
   <div class="row">
    ...
    <div class="row">
      ...
      <?php $payment_method = $this->Xin_model->get_payment_method();?>
      <div class="col-md-6">
        <div class="form-group">
          ...
          <select name="payment_method" class="select2" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_choose_payment_method');?>">
            <option value="">&nbsp;</option>
            <?php foreach($payment_method->result() as $r) {?>
            <option value="<?php echo $r->payment_method_id;?>"><?php echo $r->method_name;?></option>
            <?php } ?>
          </select>
        </div>
      </div>
