...
$lang['xin_setting_module_details'] = 'Để làm cho giao diện người dùng <strong> HRSALE </ strong> đơn giản hơn nhiều để sử dụng cho bạn và nhân viên của bạn, bạn có thể chọn mục đích sử dụng ứng dụng này cho công ty của bạn. Điều này sẽ vô hiệu hóa các mô-đun không mong muốn và cung cấp cho bạn trải nghiệm người dùng tốt hơn. ';
