...
$("#f_nominee_information").submit(function (e) {
    /*Form Submit*/
    e.preventDefault();
    var obj = $(this), action = obj.attr('name');
    $('.save').prop('disabled', true);
    ...
    $.ajax({
        type: "POST",
        url: e.target.action,
        data: obj.serialize() + "&is_ajax=3&data=nominee_info&type=nominee_info&form=" + action,
        cache: false,
        success: function (JSON) {
            if (JSON.error != '') {
                console.log(JSON);
...
/* Update mediclaim information */
$("#f_mediclaim").submit(function (e) {
    /*Form Submit*/
    e.preventDefault();
    var obj = $(this), action = obj.attr('name');
    $('.save').prop('disabled', true);
    ...
    $.ajax({
        type: "POST",
        url: e.target.action,
        data: obj.serialize() + "&is_ajax=3&data=mediclaim&type=mediclaim&form=" + action,
        cache: false,
        success: function (JSON) {
            if (JSON.error != '') {
                console.log(JSON);
